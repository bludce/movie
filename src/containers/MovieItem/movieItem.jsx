...
class MovieItem extends Component {
  ...
  renderWatchLaterClock = () => {
    if (this.props.user.auth){
      return (
        <svg onClick={() => this.toggleClick(id, 'watchLater')} className={this.state.isFavorite ? 'movie-action movie-action__watchlater movie-action__watchlater--active' : 'movie-action movie-action__watchlater'} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg"><path d="M7.52.1C3.44.1.14 3.4.14 7.5c0 4.06 3.3 7.37 7.38 7.37s7.38-3.3 7.38-7.4C14.9 3.42 11.6.1 7.52.1zm3.26 9.52c-.12.18-.36.24-.55.12l-2.95-1.9-.05-.03H7.2l-.02-.04-.02-.03-.02-.03-.02-.03v-.04-.08-.05l.02-4.8c0-.23.18-.4.4-.4.2 0 .37.17.38.38l-.02 4.6 2.76 1.78c.2.12.24.37.12.55v.02z"/></svg>
      )
    }
    else {
      return (
